...
public final class Networking {
  ...
  public static final Identifier ITEM_ADDED_S2C = Identifier.of(Constants.MOD_ID, "item_added_s2c");
  ...
  public record ItemAddedS2C(ItemStack stack) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, ItemAddedS2C> CODEC = PacketCodec.tuple(
